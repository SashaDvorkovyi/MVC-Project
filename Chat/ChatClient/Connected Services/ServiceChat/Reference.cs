...
namespace ChatClient.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendMssage")]
        void SendMssage(string message, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendMssage")]
        System.Threading.Tasks.Task SendMssageAsync(string message, int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChatCallback {
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/MessageCollback")]
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<ChatClient.ServiceChat.IServiceChat>, ChatClient.ServiceChat.IServiceChat {
        ...
        public void SendMssage(string message, int id) {
            base.Channel.SendMssage(message, id);
        }
        
        public System.Threading.Tasks.Task SendMssageAsync(string message, int id) {
            return base.Channel.SendMssageAsync(message, id);
        }
    }
}
